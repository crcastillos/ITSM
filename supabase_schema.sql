...
CREATE POLICY "Admin manage asset types" ON asset_types FOR ALL USING (get_user_role() = 'Admin') WITH CHECK (get_user_role() = 'Admin');
CREATE POLICY "Admin manage asset status" ON asset_status FOR ALL USING (get_user_role() = 'Admin') WITH CHECK (get_user_role() = 'Admin');
CREATE POLICY "Admin manage service categories" ON service_categories FOR ALL USING (get_user_role() = 'Admin') WITH CHECK (get_user_role() = 'Admin');
CREATE POLICY "Admin manage service priorities" ON service_priorities FOR ALL USING (get_user_role() = 'Admin') WITH CHECK (get_user_role() = 'Admin');
CREATE POLICY "Admin manage departments" ON departments FOR ALL USING (get_user_role() = 'Admin') WITH CHECK (get_user_role() = 'Admin');
CREATE POLICY "Admin manage districts" ON districts FOR ALL USING (get_user_role() = 'Admin') WITH CHECK (get_user_role() = 'Admin');
...
-- services: Cualquiera logueado puede ver el catálogo
